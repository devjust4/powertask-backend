...
class MainSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($students as $student) {
            ...
            if($student->periods()->get()->isEmpty() && !$student->tasks()->get()->isEmpty() && !$student->subjects()->get()->isEmpty()) {
            ...
            if($student->events()->get()->isEmpty()) {
                ...
                $this->createEvent('Exámen empresa', 'exam', 0, 'Notas de examen de empresa', 1647334800, 1647344400, NULL, NULL, array_rand($subject_ids), $student->id);
                $this->createEvent('Exámen matematicas', 'exam', 0, 'Notas de examen de matematicas', 1648900800, 1648906800, NULL, NULL, array_rand($subject_ids), $student->id);
